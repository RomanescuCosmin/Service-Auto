...
CREATE SEQUENCE FILE_REPOSITORY_SEQ;
CREATE TABLE FILE_REPOSITORY
(
    ID                 BIGINT PRIMARY KEY NOT NULL DEFAUL NEXTVAL('FILE_REPOSITORY_SEQ'),
...
(
    ...
    CONSTRAINT PROGRAMARE_X_FILE_FK FOREIGN KEY (FK_FILE_REPOSITORY) REFERENCES FILE_REPOSITORY (ID),
